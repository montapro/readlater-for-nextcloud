      ...
      >
        <View style={styles.cardHeader}>
          <View style={styles.cardIcon}>
            {showFavicon && imageSource ? (
              ...
              <Link2
                color={link.isRead ? colors.textMuted : colors.primary}
                size={20}
              />
            )}
          </View>
          <View style={styles.cardContent}>
            ...
            <Text
              style={[styles.cardUrl, { color: colors.textSecondary }]}
              numberOfLines={1}
            >
              {link.url}
            </Text>
        ...
        <View
          style={[
            styles.cardActions,
            {
              backgroundColor: colors.cardActionsBg,
        ...
        >
          ...
          >
            <CheckCircle
              color={link.isRead ? colors.success : colors.textSecondary}
              size={18}
            />
          </TouchableOpacity>
